...
<html>
	<head>
		...
		<script type="text/javascript" src="js/trplan_check.js"></script>
			...
			<tr>
				...
				<td valign="top" bgcolor="#F7F8F9">
					<form action="TrainingMangment.do?method=findplanmh" method="POST">
						...
						<b class="flip" id="3" align="center" >
						添加计划
					</b>
					</form>
					<hr>
					<div class="panel" id="4">
					<form action="TrainingMangment.do?method=addplan" method="post">
						计划适用部门：
						<select size="1" name="department" id="a_department">
							<option value="所有部门">
								所有部门
							</option>
							<option value="人事部">
						...
						培训名称: 
						<input type="text" name="trf" id="a_trf">
						培训对象:
						<input type="text" name="trd" id="a_trd">
						培训内容：
						<input type="text" name="trn" id="a_trn">
						<br>
						负责人:
						<select name="fzr" id="a_fzr">
							<%
								while (it1.hasNext()) {
									Information information = (Information) it1.next();
							%>
							<option value="<%=information.getUserid()%>">
								<%=information.getUsername()%>
							</option>
						...
						培训开始时间:
						<input type="text" name="trst" id="dateDemo">
						培训持续时间:
						<input type="text" name="trc" id="a_trc">
						<input type="submit" value="添加培训计划" id="a_trplan">
					</form>
					</div>
						...
						<tbody>
							...
							<tr id="<%=trp.getTrid()%>"
								...
								<td>
									<div align="center">
										<select id="userid1<%=trp.getTrid()%>">
											<%
												List listinfo1 = (List) session.getAttribute("list");
													Iterator it2 = listinfo1.iterator();
													while (it2.hasNext()) {
								...
								<td>
									...
									<div align="center">
										<a
											href="TrainingMangment.do?method=findTrainingplanbyid&trid=<%=trp.getTrid()%>"><img
												src="images/icon2_090.png" /> </a>
									</div>
								</TD>
								<TD>
									<div align="center">
