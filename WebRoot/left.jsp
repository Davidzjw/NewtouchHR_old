				...
				<td width="182" valign="top">
					<div id="container">
						...
						<div class="content">
							...
							<ul class="MM">
								<li>
									<a href="findUserbymh.do?method=findall" target="main">员工管理</a>
								</li>
								<li>
								...
								<li>
									<a href="fusionCharts.jsp" target="main">统计分析</a>
								</li>
							</ul>
						</div>
						<h1 class="type">
						...
						<div class="content">
							...
							<ul class="MM">
								<li>
									<a href="addRecruitment.jsp" target="main">新增招聘</a>
								</li>
								<li>
									<a
								...
								<li>
									<a href="addCandidates.jsp" target="main">新人应聘</a>
								</li>
								<li>
					...
					<div class="content">
						...
						<ul class="MM">
							...
							<li>
								<a href="addNotice.jsp" target="main">增加公告</a>
							</li>
