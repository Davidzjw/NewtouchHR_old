	...
	<table width="100%" cellpadding="0" cellspacing="0" border="0" height="100%">
		...
		<tr>
			...
			<td valign="top" bgcolor="#F7F8F9">
				...
				<form action="addNotice.do?method=addNotice" method="POST">
					<table  width="100%"  align="center" height="95%">
						...
						<tr>
							...
							<TD>
								<div align="left">
									<textarea cols="60" rows="33" name="ncontent" id="ncontent"></textarea>
								</div>
							...
							<input type="hidden" name="username"
								value="<%=id%>" />
							<input type="hidden" name="datetime" value="<%=new Date()%>" /><tr>
							<TD>
								<div align="center">
