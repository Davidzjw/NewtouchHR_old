				...
				<td valign="top" bgcolor="#F7F8F9">
					<form action="TrainingMangment.do?method=findEva" method="POST">
						...
						<select name="username">
							...
							<%
								...
								while (ite.hasNext()) {
									Trainingapproval trainingapproval = (Trainingapproval) ite.next();
							%>
							<option value="<%=trainingapproval.getInformation().getUserid()%>">
					...
					<table id="data" width="100%"  align="center">
						...
						<tbody>
							...
							%>
							<tr onMouseOver=this.className = 'tr_over' onMouseOut=this.className=''  id="<%=approval.getTaid()%>">
