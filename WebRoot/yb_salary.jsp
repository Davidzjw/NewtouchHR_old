		...
		<tr>
			...
			<td valign="top" bgcolor="#F7F8F9">
				...
				<form action="findSalarybymh.do?method=findSalarybymh" method="POST">
					...
					员工姓名:
					<input type="text" name="cxusername">
					<input type="hidden"
						value="<%=session.getAttribute("department")%>"
						name="department">
					<input type="hidden" value="<%=session.getAttribute("level")%>"
						name="level">

					<input type="submit" value="查询">
					<b class="flip" id="3" align="center"> 录入薪金 </b>
				</form>
				<hr>
							...
							<tr>
								...
								<td>
									<select size="1" name="username" id="username">
										...
										<%
											List inforList = (List) session.getAttribute("listybInformation");
